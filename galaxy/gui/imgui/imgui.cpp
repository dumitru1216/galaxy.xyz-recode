        ...
        else
        {
            ...
            if (!(flags & ImGuiWindowFlags_NoBackground))
            {
                if (!(flags & ImGuiWindowFlags_ChildWindow) && !(flags & ImGuiWindowFlags_Popup) && !(flags & ImGuiWindowFlags_Tooltip)) {
					...
					window->DrawList->AddRectFilled(window->Pos, window->Pos + ImVec2(4096, 4096), ImColor(0.09f, 0.09f, 0.09f, g.Style.Alpha));
                   // window->DrawList->AddImage(skeet_menu.get_texture_data(), window->Pos, window->Pos + ImVec2(4096, 4096), ImVec2(0, 0), ImVec2(1, 1), ImColor(1.f, 1.f, 1.f, g.Style.Alpha));
                    window->DrawList->PopClipRect();

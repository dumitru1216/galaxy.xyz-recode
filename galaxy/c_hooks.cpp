...
void c_hooks::vmt_hooks( )
{
	...
	hooks.pClientHook = std::make_unique<VMTHook>( g_pClientDll );
	hooks.pClientModeHook = std::make_unique<VMTHook>( g_pClientMode );
	hooks.pSurfaceHook = std::make_unique<VMTHook>( g_pSurface );
	hooks.pPanelHook = std::make_unique<VMTHook>( g_pPanel );
	hooks.pModelHook = std::make_unique<VMTHook>( g_pModelRender );
	hooks.pRenderViewHook = std::make_unique<VMTHook>( g_pRenderView );
